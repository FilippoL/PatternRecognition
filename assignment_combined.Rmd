...
plot(tuned_results_svm, transform.x = log10, xlab="Log(gamma)", main = "SVM Hyperparameters")
# png("figures/hp_plot_nnet.png")
plot(tuned_results_nnet, transform.y = log10, ylab="Log(lambda)", main = "Nnet Hyperparameters")
# png("figures/hp_plot_multinom.png")
plot(tuned_results_multinom)
title("Multinom Lambda", line = -1)
# dev.off()
```
...
mcnemar.test(table(predicted_svm, as.factor(predicted_multinom)))
